...
KritaMinimalPaintOp::KritaMinimalPaintOp(const KritaMinimalPaintOpSettings *settings, KritaPainter * painter, KritaImageWSP image)
        : KritaPaintOp(painter)
{
    ...
    m_minimalBrush = new MinimalBrush( &m_properties, transfo );
}

KritaMinimalPaintOp::~KritaMinimalPaintOp()
{
    delete m_minimalBrush;
}

qreal KritaMinimalPaintOp::paintAt(const KritaPaintInformation& info)
{
    ...
    m_minimalBrush->paint(m_dab, x1, y1, painter()->paintColor());
