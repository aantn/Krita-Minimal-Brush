...
#ifndef KRITA_MINIMAL_PAINTOP_SETTINGS_H_
#define KRITA_MINIMAL_PAINTOP_SETTINGS_H_
...
class KritaMinimalPaintOpSettings : public KritaPaintOpSettings
{

public:
    KritaMinimalPaintOpSettings();
    virtual ~KritaMinimalPaintOpSettings() {}
